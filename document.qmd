...
To help set the right parameter values, you can use the code here to visualize the means in each group. The code below simulates the data once, producing a sample of the data that will exactly match the parameter values. It then visualizes the means so you can see
